...
import { CalendarCheck, Award, ArrowRightToLine, ArrowLeft, Menu } from "lucide-react";

interface EducationScheduleStepProps {
  handleBack: () => void;
  onContinue: () => void;
}

const EducationScheduleStep: React.FC<EducationScheduleStepProps> = ({ handleBack, onContinue }) => {
  return (
    <div className="min-h-screen bg-background">
      <div className="container px-4">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg p-4 space-y-4">
              <p className="text-sm text-gray-600">
                청소연구소 교육은 여성인력개발센터·여성발전센터·50+플러센터와 함께하며, 그 외 전문 교육장에서 진행됩니다.
              </p>
          ...
          <Button 
            className="w-full bg-primary-cleaner hover:bg-primary-cleaner text-white py-6"
            onClick={onContinue}
          >
            교육 예약하기
          </Button>
...
export default EducationScheduleStep;
